...
import { BusinessAccountClass } from "@solomon-ai/component-library";
import { AddressClass } from "@solomon-ai/component-library";
import { TagClass } from "@solomon-ai/component-library";
import {
  CalendarIcon,
  ChartPieIcon,
...
export const MultiStepCreateBusinessAccountForm: React.FC<{
  ...
  return (
    <Card className={cn("md:p-[2%] w-full", className)}>
      <div className="flex flex-row gap-2">
        {/** we do not show this component on small */}
