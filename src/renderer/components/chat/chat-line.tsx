...
import { BrainCircuit, BrainCog, PersonStandingIcon } from "lucide-react";
...
export function ChatLine({ role = "assistant", content }: ChatGPTMessage) {
  ...
  return (
    ...
    >
      <div className="float-right max-w-lg px-4 py-5 mb-5 bg-white border rounded-lg shadow-lg ring-1 ring-zinc-100 dark:text-gray-600 sm:px-6">
