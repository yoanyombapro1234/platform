...
import { HistoricalAccountBalanceChart } from "@solomon-ai/component-library";
    ...
    return (
      <CreditAccountCardContext.Provider value={account}>
        <Card className={cn("p-2", className)}>
          <CardHeader className="flex items-start space-y-0 gap-x-5">
            <div className="space-y-1">
              ...
              <div>
                <div className="flex justify-start flex-1 gap-2">
                  <Badge
                    className="font-bold text-black bg-white border border-black"
                    style={{
                      fontSize: "8px",
                    }}
                  >
...
const CreditAccountAprs: React.FC<{
  ...
  return (
    <div>
      <Card className="flex flex-col gap-3 p-3 rounded-lg">
        <div>
