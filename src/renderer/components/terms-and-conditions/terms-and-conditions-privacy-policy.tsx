...
Protecting your private information is our priority. This Statement of Privacy applies to solomon-ai, and
simfiny, Inc and governs data collection and usage. For the purposes of this Privacy Policy, unless
otherwise noted, all references to simfiny, Inc include https://solomon-ai.io and solomon-ai. The solomon-ai
application is a budgeting and expense planning application. By using the solomon-ai application, you
consent to the data practices described in this statement.

## Collection of your Personal Information

In order to better provide you with products and services offered, solomon-ai may collect personally
identifiable information, such as your:

- First and Last Name
- E-mail Address

If you purchase solomon-ai's products and services, we collect billing and credit card information. This
...
solomon-ai collects and uses your personal information to operate and deliver the services you have
requested.

solomon-ai may also use your personally identifiable information to inform you of other products or
services available from solomon-ai and its affiliates.

## Sharing Information with Third Parties

solomon-ai does not sell, rent or lease its customer lists to third parties.

solomon-ai may share data with trusted partners to help perform statistical analysis, send you email, or
provide customer support. All such third parties are prohibited from using your personal information
except to provide these services to solomon-ai, and they are required to maintain the confidentiality of
your information.

solomon-ai may disclose your personal information, without notice, if required to do so by law or in the
good faith belief that such action is necessary to: (a) conform to the edicts of the law or comply
with legal process served on solomon-ai or the site; (b) protect and defend the rights or property of
solomon-ai; and/or (c) act under exigent circumstances to protect the personal safety of users of
solomon-ai, or the public.
...
solomon-ai does not knowingly collect personally identifiable information from children under the age
...
## Disconnecting your solomon-ai Account from Third Party Websites

You will be able to connect your solomon-ai account to third party accounts. **BY CONNECTING
YOUR solomon-ai ACCOUNT TO YOUR THIRD PARTY ACCOUNT, YOU
...
User's connect solomon-ai to their bank account's via a third party service called Plaid. You can
disconnect your bank account from solomon-ai in the "View Bank Accounts" menu. Alternatively, you
can revoke solomon-ai's access to your bank account information by going to https://my.plaid.com/

## E-mail Communications

From time to time, solomon-ai may contact you via email for the purpose of providing announcements,
...
solomon-ai, you may opt out of such communications by clicking the "unsubscribe" button in the footer
or body of the emails. Or by reaching out to support@solomon-ai.app.
...
solomon-ai reserves the right to change this Privacy Policy from time to time. We will notify you about
...
solomon-ai welcomes your questions or comments regarding this Statement of Privacy. If you believe
that solomon-ai has not adhered to this Statement, please contact solomon-ai at:
