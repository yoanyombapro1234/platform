...
Welcome to solomon-ai.io. The solomon-ai.io website (the "Site") is comprised of various web pages operated by simfiny, Inc
("simfiny"). solomon-ai.io is offered to you conditioned on your acceptance without modification of the terms, conditions,
and notices contained herein (the "Terms"). Your use of solomon-ai.io constitutes your agreement to all such Terms. Please
read these terms carefully, and keep a copy of them for your reference.

solomon-ai.io is a Financial Planning Software Site.

simfiny is an open source financial planning application. solomon-ai.io is a hosted version of this application used to help
manage and budget for recurring or future expenses.

## Privacy

Your use of solomon-ai.io is subject to simfiny's Privacy Policy. Please review our Privacy Policy, which also governs the
Site and informs users of our data collection practices.

## Electronic Communications

Visiting solomon-ai.io or sending emails to simfiny constitutes electronic communications. You consent to receive electronic
...
thirteen. If you are under 18, you may use solomon-ai.io only with permission of a parent or guardian.
...
solomon-ai.io may contain links to other websites ("Linked Sites"). The Linked Sites are not under the control of simfiny
...
Certain services made available via solomon-ai.io are delivered by third party sites and organizations. By using any
product, service or functionality originating from the solomon-ai.io domain, you hereby acknowledge and consent that simfiny
may share such information and data with any third party with whom simfiny has a contractual relationship to provide the
requested product, service or functionality on behalf of solomon-ai.io users and customers.

## No Unlawful or Prohibited Use/Intellectual Property

You are granted a non-exclusive, non-transferable, revocable license to access and use solomon-ai.io strictly in accordance
...
not use the simfiny Content accessed through solomon-ai.io in any country or in any manner prohibited by any applicable
...
simfiny reserves the right, in its sole discretion, to change the Terms under which solomon-ai.io is offered. The most
...
Email Address: admin@Solomon-AI.io
