 ...
 * this mutation.
 */
const VerifyEmailV2 = api.injectEndpoints({
  endpoints: (builder) => ({
    verifyEmailV2: builder.mutation({
      query: (req: { userID: string; profileType: ProfileType }) => ({
        url: `/v2/gateway/user/verification/${req.userID}/type/${req.profileType}`,
        method: "POST",
      }),
      // TODO: clean this up
      transformResponse: (
...
export { VerifyEmailV2 };
export const { useVerifyEmailV2Mutation } = VerifyEmailV2;
